...
/**************************************************************************************************
 *
 * Implements New Hope key exchange algorithm. 
 *
...
class NewHopeKeyExchange {
  ...
  public byte[][] respAgreement (NewHopePrivateKey kR, NewHopePublicKey kI) {
  ...
  public byte[][] respAgreement (NewHopePrivateKey kR, NewHopePublicKey kI, RingElt eprime) {
    // Given eprime, compute and return: [shared secret, reconciliation data]
  ...
  public byte[] initAgreement (NewHopePrivateKey kI, NewHopePublicKey kR, byte[] rdata) {
